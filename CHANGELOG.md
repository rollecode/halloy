...
- `buffer.server_messages.marker` setting (`"dot"` (default) or `"none"`) to control whether the leading marker is shown on system messages (server, action and internal status)
